...
function Footer() {
    return ( <
        ...
        div > <
        p >
        Sed ut perspiciatis unde omnis iste natus er sit voluptatem accusantium dolore.ea commo do consequat.Duis aute irure dolor in re
        prehenderit in . <
        /p> <
        div class = "ab-social" >
        <
        ...
        p >
        123 Street, Gandy Street, Syracuse New York - 13221. <
        /p> <
        p >
        Phone: +1 315 - 234 - 3812 Email: info @goru.com <
        /p> < /
        aside > <
        /div> <
        ...
        <
        div class = "copys-text" > < i class = "twi-copyright" > < /i> aman kumar | All Rights Reserved</div >
        <
        /div> < /
        div > <
        /div> < /
